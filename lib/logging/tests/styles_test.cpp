...
TEST_CASE("style apply") {
    style all = BOLD | FG_BLACK | FAINT | ITALIC | FG_GREEN | BG_MAGENTA | UNDERLINE | LINE_THROUGH | DOUBLE_UNDERLINE | OVERLINE;
    std::string_view allseq = "\x1b[32m\x1b[45m\x1b[1m\x1b[2m\x1b[3m\x1b[4m\x1b[9m\x1b[21m\x1b[53m";
    
    SUBCASE("apply_seq") {
        CHECK(apply_seq(all) == allseq);
    }
